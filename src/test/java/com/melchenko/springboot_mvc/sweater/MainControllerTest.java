...
//	@WithUserDetails("999")
	...
	public void mainPageTest() throws Exception {
		this.mockMvc.perform(get("/"))
			...
			.andExpect(xpath("//div[@id='navbarSupportedContent']/div").string("999"));
	}
...
//	@Sql
	...
	public void addMessageToListTest() throws Exception {
		...
		this.mockMvc.perform(multipart)
			...
			.andExpect(xpath("//*[@id='message-list']/div[@data-id='10']").exists()) // alter sequence hibernate_sequence restart with 10
